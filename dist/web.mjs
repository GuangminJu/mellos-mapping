...
async function openWebPreview(defaultFile, entry, page) {
  ...
  return page === void 0 ? url : `${url}?page=${encodeURIComponent(page)}`;
}
  ...
  const server = createServer((req, res) => {
    ...
    try {
      ...
      if (req.method === "GET" && route === "api/health") {
        send(res, 200, JSON.stringify({ file: defaultFile, pid: process.pid }));
        return;
      }
