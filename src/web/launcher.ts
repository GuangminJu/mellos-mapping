...
export async function openWebPreview(defaultFile: string, entry: string, page?: string): Promise<string> {
  ...
  return page === undefined ? url : `${url}?page=${encodeURIComponent(page)}`;
}
