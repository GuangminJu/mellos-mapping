...
import { declareLayer, declareNode } from '../domain/ops.js';
import { EMPTY_MAP, type LayerId, type MellosMap, type NodeId, type Rank, type Result } from '../domain/types.js';

/** Injected fault state: how many renames still fail, and every file written. */
const fault = vi.hoisted(() => ({ renameFailures: 0, written: [] as string[] }));
